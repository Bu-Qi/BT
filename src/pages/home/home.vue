...
export default {
  data() {
    return {
      contractAddress: "0x3FB708e854041673433e708feDb9a1b43905b6f7", // 合约地址
  ...
  async created() {
    this.contractAddress = process.env.NODE_ENV == 'development' ? "0x3FB708e854041673433e708feDb9a1b43905b6f7" : '0x3FB708e854041673433e708feDb9a1b43905b6f7';
